...
fname = '/data/frame/a/kevintg2/cm1/output/sickle/_0_1min/sklinv0_1min.nc'
print(fname)
...
for i in range(num_seeds_x):
    xpos[0,:,:,i] = 257+(0.5*i) #Choose bottem left corner x of box and spacing of parcels

#y-position   
for i in range(num_seeds_y):
    ypos[0,:,i,:] = 316+(i) #Choose bottem left corner y of box and spacing of parcels
...
for t in range(time_steps-1):
    ...
    for i in range(len(xloc)):
        ...
        #coordres.append((zloc[i]-1, yloc[i], xloc[i]))
    ...
    #print('zpos[t,:,:,:]: ', zpos[t,:,:,:])
    #print('zpos_heightASL[t,:,:,:]: ',zpos_heightASL[t,:,:,:])
    #print('zpos_heightASL_change: ',zpos_heightASL_change)
    #print('zs_change: ',zs_change)
    #print('zpos_vert_res[t,:,:,:]: ',zpos_vert_res[t,:,:,:])
    ...
    #print('zpos[t+1,:,:,:]: ',zpos[t+1,:,:,:])
    #print('zpos_heightASL[t+1,:,:,:]: ',zpos_heightASL[t+1,:,:,:])
...
#timetag = '057'
np.save('FORWtrajs_0_1min_0-2km_zFIX/'+timetag+'xpos', xpos)
np.save('FORWtrajs_0_1min_0-2km_zFIX/'+timetag+'ypos', ypos)
np.save('FORWtrajs_0_1min_0-2km_zFIX/'+timetag+'zpos', zpos)
np.save('FORWtrajs_0_1min_0-2km_zFIX/'+timetag+'zpos_heightASL', zpos_heightASL)
np.save('FORWtrajs_0_1min_0-2km_zFIX/'+timetag+'%s' %var_name1, variable1)
np.save('FORWtrajs_0_1min_0-2km_zFIX/'+timetag+'%s' %var_name2, variable2)
np.save('FORWtrajs_0_1min_0-2km_zFIX/'+timetag+'%s' %var_name3, variable3)
np.save('FORWtrajs_0_1min_0-2km_zFIX/'+timetag+'%s' %var_name4, variable4)
np.save('FORWtrajs_0_1min_0-2km_zFIX/'+timetag+'%s' %var_name5, variable5)
np.save('FORWtrajs_0_1min_0-2km_zFIX/'+timetag+'%s' %var_name6, variable6)
